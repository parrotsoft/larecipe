...
<head>
    ...
    @if(config('larecipe.google-analytics.id') !== null && config('larecipe.google-analytics.id') !== '')
        <!-- Google tag (gtag.js) -->
        <script async
                src="https://www.googletagmanager.com/gtag/js?id={{ config('larecipe.google-analytics.id') }}"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', '{{ config('larecipe.google-analytics.id') }}');
        </script>
    @endif
